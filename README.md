Integrante 1: Fernando Javier Lincopan Araya - 21.860.800-0 - FernandoLinco1

Esta aplicación se controlara con tres menus el primer menu que se seleccionara a que menu se desea ingresar,
ya sea Menu Usuario o Menu Analisis.

El Menu Usuario permite: registrar actividad, modificar actividad, eliminar actividad, cambiar contraseña y cerrar el menu,
de un usuario especifico.

El Menu Analisis permite ver: la actividad más realizada, la actividad más realizada por cada usuario, 
el usuario con mayor procastinacion, todas las actividades y cerrar el menu.
